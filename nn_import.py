...
DATASET_PATH = "generated_dialogues.json"
...
def main():
    ...
    for dialogue in data:
        # Original dialogue_id from the data
        original_dialogue_id = dialogue['dialogue_id']
        
        # **Modify dialogue_id to match the IDs in your database**
        # Assuming the IDs in the database are the file names without the suffix
        # Example: 'PMUL4834.json_generated_d4d4343f-77a3-4d84-9305-f0f52e230815' becomes 'PMUL4834'
        dialogue_id = original_dialogue_id.split('.json_generated_')[0]
